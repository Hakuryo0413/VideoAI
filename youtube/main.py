...
backend_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "backend", "app", "video"))
...
def routine():
    ...
    description = "VideoAI" + str(now.year) +  num_to_month[now.month].upper() +  "_" + str(now.day)
